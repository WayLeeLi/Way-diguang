<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="horse_edit.aspx.cs" Inherits="DTcms.Web.admin.horse_edit"
    ValidateRequest="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>編輯跑馬燈管理資料</title>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <div class="navigation">
            <a href="javascript:history.go(-1);" class="back">後退</a>首頁 &gt; 圖片管理
        </div>
        <div id="contentTab">
            <ul class="tab_nav">
                <li class="selected"><a onclick="tabs('#contentTab',0);" href="javascript:;">編輯跑馬燈管理資料</a></li>
            </ul>
                        ...
                        <tr style="display: none;">
                            ...
                            <td>
                                <asp:DropDownList ID="ddlType" runat="server">
                                    ...
                                    <asp:ListItem Text="跑馬燈" Value="12" Selected="True" />
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtTitle" runat="server" CssClass="txtInput normal" minlength="2" style="width:500px; height:50px;"
                                    MaxLength="2000"></asp:TextBox><label>*</label>
                            </td>
                        </tr>
                        <tr>
                            <th>排 序：
