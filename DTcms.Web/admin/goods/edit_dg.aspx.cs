...
{
    public partial class edit_dg : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(_action) && _action == DTEnums.ActionEnum.Edit.ToString())
            {
                ...
                {
                    JscriptMsg("資訊不存在或已被刪除！", "back", "Error");
                    return;
                }
            }
            if (!Page.IsPostBack)
        ...
        private bool DoAdd()
        {
            ...
            model.shangpinType = txtIntroduce.Text;
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (action == DTEnums.ActionEnum.Edit.ToString()) //修改
            {
                ...
                JscriptMsg("修改商品成功！", "list_dg.aspx?channel_id=" + this.channel_id, "Success");
            }
            else //添加
            {
                ...
                JscriptMsg("添加商品成功！", "list_dg.aspx?channel_id=" + this.channel_id, "Success");
            }
        }
        #endregion
    }
