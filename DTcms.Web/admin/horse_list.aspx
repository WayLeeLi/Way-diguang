<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="horse_list.aspx.cs" Inherits="DTcms.Web.admin.horse_list" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tools_box">
            <div class="tools_bar">
                ...
                <a href="horse_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>" class="tools_btn"><span>
        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center">
                        <a href="horse_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
